enum properties{
    ...
    cssFloat,
    font,
    font_displayfont_family,
    font_familyfont_feature_settings,
    font_feature_settingsfont_kerning,
    font_language_override,
    font_optical_sizing,
    font_size,
    font_size_adjust,
    font_stretch,
    font_stretchfont_style,
    font_stylefont_synthesis,
    font_variant,
    font_variantfont_variant_alternates,
    font_variant_caps,
    ...
    font_variation_settingsfont_weight,
    font_weightforced_color_adjust,
    gap,
    grid,
    grid_area,
    grid_auto_columns,
    ...
    max_block_size,
    max_height,
    max_heightmax_inline_size,
    max_lines,
    max_width,
    max_widthmax_zoommin_block_size,
    min_height,
    min_heightmin_inline_size,
    min_width,
    min_widthmin_zoommix_blend_mode,
    negativeobject_fit,
    object_position,
    offset,
    offset_anchor,
